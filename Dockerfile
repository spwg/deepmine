...
# # --build-arg SSH_PRIVATE_KEY=<key>
# ARG SSH_PRIVATE_KEY
# RUN mkdir /root/.ssh/
# RUN echo "${SSH_PRIVATE_KEY}" > /root/.ssh/id_rsa
# RUN chmod 700 /root/.ssh/id_rsa

# # Make sure ssh key was added and we can pull from GitHub.
# RUN touch /root/.ssh/known_hosts
# RUN ssh-keyscan github.com >> /root/.ssh/known_hosts

# RUN git clone git@github.com:spwg/deepmine.git

# # Install add-apt-repository and other things.
...
# # Wipes the intermediate build to avoid having SSH key in history.
# FROM python:3.7
# COPY --from=intermediate /deepmine /code/deepmine

# # All commands relative to /code now.
# WORKDIR /code
...
# COPY . .
# CMD ["python", "assignment.py", "REINFORCE_BASELINE"]
